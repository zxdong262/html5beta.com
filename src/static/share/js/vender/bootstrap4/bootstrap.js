 ...
 */
   ...
   */
    ...
    function transitionEndTest () {
      ...
      for (const _name in TransitionEndEvent) {
     ...
     */
      ...
      _createClass(Carousel, [{
        ...
        value: function _slide (direction, element) {
          ...
          const directionalClassName = direction === Direction.NEXT ? ClassName.LEFT : ClassName.RIGHT
     ...
     */
      ...
      _createClass(Collapse, [{
        ...
        value: function _addAriaAndCollapsedClass (element, triggerArray) {
          if (element) {
            const isOpen = $(element).hasClass(ClassName.IN)
     ...
     */
      ...
      _createClass(Dropdown, [{
        ...
        value: function toggle () {
          ...
          const isActive = $(parent).hasClass(ClassName.OPEN)
        ...
        value: function _clearMenus (event) {
          ...
          for (let i = 0; i < toggles.length; i++) {
            const _parent = Dropdown._getParentFromElement(toggles[i])
     ...
     */
      ...
      _createClass(ScrollSpy, [{
        ...
        value: function _process () {
          ...
          const maxScroll = this._config.offset + scrollHeight - this._scrollElement.offsetHeight
     ...
     */
      ...
      _createClass(Tab, [{
        ...
        value: function show () {
          ...
          let target
          let previous
          const ulElement = $(this._element).closest(Selector.UL)[0]
        ...
        value: function _activate (element, container, callback) {
          ...
          const isTransitioning = callback && Util.supportsTransitionEnd() && (active && $(active).hasClass(ClassName.FADE) || Boolean($(container).find(Selector.FADE_CHILD)[0]))

          const complete = $.proxy(this._transitionComplete, this, element, active, isTransitioning, callback)
        ...
        value: function _transitionComplete (element, active, isTransitioning, callback) {
          if (active) {
            ...
            const dropdownChild = $(active).find(Selector.DROPDOWN_ACTIVE_CHILD)[0]
      ...
      _createClass(Tooltip, [{
        ...
        value: function show () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            const complete = function complete () {
              const prevHoverState = _this16._hoverState
        ...
        value: function _setListeners () {
          ...
          triggers.forEach(function (trigger) {
            if (trigger === 'click') {
              ...
              const eventIn = trigger === Trigger.HOVER ? _this18.constructor.Event.MOUSEENTER : _this18.constructor.Event.FOCUSIN
              const eventOut = trigger === Trigger.HOVER ? _this18.constructor.Event.MOUSELEAVE : _this18.constructor.Event.FOCUSOUT
